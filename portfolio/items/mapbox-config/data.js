...
const allMapStyles = [
  ...
  Layered_Satellite_Less_Labels,
  Layered_Hillshading_Demo,
  Layered_Contour_Demo,
  Mapbox_Bathymetry,
  Clear_Light,
  North_Star_Web,
  Mineral_Web,
...
// Radio Button Items
const styleOptions = [-1]; // [0, 2, 3, 1, 10, 5, 8]; // [-1] - All | [] - None | [0,1,2...]
...
// Large Dataset Upload Tutorial with Mapbox Tiling Service (MTS):
// https://www.youtube.com/watch?v=jTGohrwsi_A

// BLUE PLANET
const bluePlanetURLs = {
  1: "mapbox://antadam127.90hh4c9m",
  2: "mapbox://antadam127.2vz24zit",
  3: "mapbox://antadam127.9du19l0f",
  4: "mapbox://antadam127.9avrnps8",
  5: "mapbox://antadam127.dkvr8cmj",
  6: "mapbox://antadam127.3mmitoak",
  7: "mapbox://antadam127.9uiarz9s",
  8: "mapbox://antadam127.6kw5h8kx",
  9: "mapbox://antadam127.76j3zh3x",
  10: "mapbox://antadam127.8zzub98a",
  11: "mapbox://antadam127.co82a7rf",
  12: "mapbox://antadam127.b8xo88wh",
};

// BLACK MARBLE
const blackMarbleURL = 'mapbox://antadam127.8ijuc4bc';
...
// Random Globe Bounds
const globePos = [-85, -35, 35, 75, 105][Math.floor(Math.random() * 5)];
const randomGlobe = [
  [globePos - 75, 55],
  [globePos + 75, -55],
];
